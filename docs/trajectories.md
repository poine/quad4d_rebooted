...
$$
Y(t) = \begin{pmatrix}x(t)= x_0 + v_x * (t-t_0) \\
                      y(t)= y_0 + v_y * (t-t_0) \\ 
					  z(t)= z_0 + v_z * (t-t_0) \\
					  \psi(t) \end{pmatrix} \quad t \in [t_0, t_1[
$$
...
Y(t) = \begin{pmatrix}x(t)= c_x + r \cos(\omega t) \\
                      y(t)= c_y + r \sin(\omega t) \\ z(t) \\ \psi(t) \end{pmatrix} \quad t \in [t_0, t_1[
$$
...
$$
Y(t) = \begin{pmatrix}x(t)= a_{0x} + a_{1x} t + a_{2x} t^2 + \dots  \\
                      y(t)= a_{0y} + a_{1y} t + a_{2y} t^2 + \dots  \\
					  z(t)= a_{0z} + a_{1z} t + a_{2z} t^2 + \dots \\ \psi(t) \end{pmatrix} \quad t \in [t_0, t_1[
$$
...
<img src="../graphics/demo_poly.png" width="800">
...
<img src="../graphics/demo_composite.png" width="800">
	
Oval

 * classe `CompositeTraj` dans <a href="https://github.com/poine/pat/blob/master/src/pat3/vehicles/rotorcraft/multirotor_trajectory.py">pat3/vehicles/rotorcraft/multirotor_trajectory.py</a>
...
<a href="https://github.com/poine/quad4d_rebooted/blob/main/src/demo_pat_trajectories.py">exemple</a>
...
/home/poine/work/pat/src/pat3/test/rotorcraft/test_07_traj_dynamics.py


$$
Y(t) = \begin{pmatrix}x(t) \\ y(t) \\ z(t) \\ \psi(t) \end{pmatrix} \quad \rightarrow \quad
